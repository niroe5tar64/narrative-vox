...
- 実行時は必ず `tools/skills/git-commit-ja-prefix/scripts/ai_commit.sh` を使って検証付きでコミットする。

```bash
tools/skills/git-commit-ja-prefix/scripts/ai_commit.sh <<'EOF'
<type>: <subject>
