...
- 実行時は必ず `tools/skills/git-split-commit-ja/scripts/ai_commit.sh` を使う。

```bash
tools/skills/git-split-commit-ja/scripts/ai_commit.sh <<'__COMMIT__'
<type>: <subject>
