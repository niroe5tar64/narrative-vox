...
const NEXT_COMMAND: Record<string, { command: string; description: string } | null> = {
  "build-text": { command: "build-project", description: "テキスト → VOICEVOX プロジェクト生成" },
  "build-project": { command: "build-audio", description: "プロジェクト → 音声合成" },
  "build-audio": null,
  "build-all": null,
  "check-run": null,
  "prepare-run": { command: "build-text", description: "台本 → VOICEVOX テキスト変換" },
  "dict-sync": null,
};
