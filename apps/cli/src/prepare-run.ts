...
function printUsage() {
	console.log(`Usage:
  bun apps/cli/src/prepare-run.ts [--run-dir <data/projects/.../run-YYYYMMDD-HHMM>] [--source-run-dir <data/projects/.../run-YYYYMMDD-HHMM>] [--project-id <id>] [--run-id <run-YYYYMMDD-HHMM>] [--projects-dir <data/projects>] [--default-project-id <id>] [--default-source-run-dir <data/projects/.../run-YYYYMMDD-HHMM>] [--default-run-id <run-YYYYMMDD-HHMM>] [--no-prompt]
