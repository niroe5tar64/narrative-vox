...
import { getJapaneseMorphTokenizer, type MorphTokenizer } from "./dictionary-tokenizer.ts";
export { getJapaneseMorphTokenizer, type MorphTokenizer } from "./dictionary-tokenizer.ts";
