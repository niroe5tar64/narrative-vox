...
function resolveSpeedPreset(
  ...
  if (!speedProfiles) {
    throw new Error(
      `Speed preset "${speedPreset}" was requested but no speed profiles are configured. Set --speed-profiles or add configs/voicevox/speed-profiles.json`
    );
  }
