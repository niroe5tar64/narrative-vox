...
const usageByCommand: Record<CommandName, string> = {
  "build-text":
    "Usage:\n  bun src/cli/main.ts build-text --script <stage3/E##_script.md> [--run-dir <projects/.../run-...>] [--episode-id E##] [--project-id <id>] [--run-id <run-YYYYMMDD-HHMM>] [--stage4-config <configs/voicevox/stage4_text_config.json>]",
  "build-project":
  ...
  "build-all":
    "Usage:\n  bun src/cli/main.ts build-all --script <stage3/E##_script.md> [--run-dir <projects/.../run-...>] [--run-id <run-YYYYMMDD-HHMM>] [--stage4-config <configs/voicevox/stage4_text_config.json>] [build-text/build-project options]",
  "check-run":
